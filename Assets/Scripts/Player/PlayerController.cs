...
public class PlayerController : MonoBehaviour
{
    ...
    {
        if (activeData.isInvincible || activeData.isDead || activeData.isDefensive) return;
        ...
        if (activeData.currentHealth <= 0)
        {
            ...
            {
                Debug.LogError("CRITICAL ERROR: Could not find PlayerInputController to trigger death!");
            }
        }
